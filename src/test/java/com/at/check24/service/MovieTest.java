...
public class MovieTest {
    ...
    private List<Movie> movies() {
        ...
        movieList.add(new Movie(1, GenreType.DRAMA, "Friends", director().get(2).getId(), "", RateType.FOUR, "Follow the lives of six reckless adults living in Manhattan, as they indulge in adventures which make their lives both troublesome and happening."));
    ...
    public void getMovieByTitle() {
        when(movieRepository.findMovieByTitle("Friends")).thenReturn(Optional.of(movies().get(2)));
